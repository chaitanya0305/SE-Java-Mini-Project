...
public class ServerDownload extends Thread
{
    ...
    */
    ...
    public void run(){
    	try {
            //System.out.println("Starting try..., port " + peerServerPort);
    			dwldServerSocket = new ServerSocket(peerServerPort);
//System.out.println("Starting try...1 " + directoryPath);
    			dwldSocket = dwldServerSocket.accept();
//System.out.println("Starting try...2 directory path" + directoryPath);
    			new ServerDownloadThread(dwldSocket,directoryPath).start();
//System.out.println("Starting try...3");
        } 
