    ...
    public Server() throws NumberFormatException, IOException
    {
    	...
    	try{
			//System.out.println("Welcome to BoltShare!");
    			...
    			System.out.println("This is the Server Side at BoltShare. ");
    			System.out.println(" ");
    			System.out.println("Waiting for the Client(s) to be connected..");
    	}
    	catch(IOException e)
    	{
    		e.printStackTrace();
...
class ServerTestClass extends Thread
{
	...
	public void run()
    {
    	...
    	{  
    		...
    		System.out.println("All the available files from the given directory have been received by the Server!");
        ...
        System.out.println("Searching for the required file..");
